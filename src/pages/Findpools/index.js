...
},
{
  ...
  "boostCRV" : 1,
  "boostBAL" : 0,
  "netAPR": 5.65072, //2.4 + 2.55 + 0.00072(min) + 0.7(LDO)
  "investStep": [
    {
      "protocol" : "Lido",
      "action" : "Deposit ETH",
        ...
        <div style={{paddingTop:"30px"}}/>
          <OverBox style={{display:"flex", flexDirection:"row"}}>
              ...
              <div class="block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 class="mb-2 text-xl font-bold tracking-tight text-blue-800 dark:text-white">
                  {isloading ? 
              ...
              <div class="block p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <h5 class="mb-2 text-1xl font-bold tracking-tight text-black dark:text-white">
                  Connected Protocols
                </h5>
                <h5 class="ml-5 mb-5 text-1xl tracking-tight text-black dark:text-white">
                ...
                <span class="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
                  <img class="w-6 h-6 rounded-full" src={Lido} alt=""/>
                  </span>
